  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Layofftivity" },
      {
        ...
        content: "Rebuild routine, purpose, and belonging by volunteering with the same people.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Sora:wght@700&family=Young+Serif&family=Nunito:wght@400;500;600;700;800&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
