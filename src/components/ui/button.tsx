...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2.5 whitespace-nowrap rounded-full text-[15px] font-bold cursor-pointer transition-[transform,background-color,color] duration-[120ms] ease-out focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary-soft disabled:pointer-events-none disabled:bg-muted disabled:text-[var(--lo-green-faint)] disabled:cursor-not-allowed [&_svg]:pointer-events-none [&_svg]:size-[18px] [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "bg-card text-foreground ring-1 ring-[var(--lo-fresh-sprout)] hover:bg-secondary",
